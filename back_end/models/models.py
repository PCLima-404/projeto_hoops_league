...
from sqlalchemy import String, ForeignKey, Enum, create_engine, Column
from sqlalchemy.dialects.mysql import INTEGER, TINYINT, SMALLINT, DECIMAL

DATABASE_URL="mysql+pymysql://root:senha_2026_MySQL@localhost:3306/hoops_league"
...
class Jogador(Base):
    ...
    overall: Mapped[int] = mapped_column(TINYINT(unsigned=True), nullable=False, default = 58)
